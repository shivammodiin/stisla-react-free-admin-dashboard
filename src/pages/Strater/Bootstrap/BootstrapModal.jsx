          ...
          <div class="row">
            <div class="col-12 col-md-6 col-lg-6">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <p class="mb-2">
                    Use the Bootstrap method to create modal. You need to create
                    an HTML structure for modal and the following button will
                    trigger it.
                  </p>
                  <button
            ...
            <div class="col-12 col-md-6 col-lg-6">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <button class="btn btn-primary" id="modal-1">
                    Launch Modal
                  </button>
                </div>
              </div>
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <button class="btn btn-primary" id="modal-2">
                    Launch Modal
                  </button>
                </div>
              </div>
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="buttons">
                    <button class="btn btn-primary" id="modal-3">
                      Buttons
                    </button>
