              ...
              <div class="card-body">
                <div class="summary">
                  ...
                  <div class="summary-item">
                    <h6>
                      Item List <span class="text-muted">(3 Items)</span>
                    </h6>
                    <ul class="list-unstyled list-unstyled-border">
                      <li class="media">
                        <a href="#">
                ...
                <ul class="list-unstyled list-unstyled-border">
                  ...
                  <li class="media">
                    ...
                    <div class="media-body">
                      ...
                      <div class="text-small text-muted">
                        Serj Tankian <div class="bullet"></div> 4 Min
                      </div>
                    </div>
                  </li>
                  <li class="media">
                    ...
                    <div class="media-body">
                      ...
                      <div class="text-small text-muted">
                        Ujang Maman <div class="bullet"></div> 8 Min
                      </div>
                    </div>
                  </li>
                  <li class="media">
                    ...
                    <div class="media-body">
                      ...
                      <div class="text-small text-muted">
                        Farhan A Mujib <div class="bullet"></div> 21 Min
                      </div>
                    </div>
                  </li>
                </ul>
